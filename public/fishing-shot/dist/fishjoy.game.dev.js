...
(function () {
  ...
  c.sources = [{
    id: "mainbg",
    size: 456,
    src: "fishing-shot/images/game_bg_2_hd.jpg?" + Math.random()
  }, {
    id: "bottom",
    size: 50,
    src: "fishing-shot/images/bottom.png?" + Math.random()
  }, {
    id: "fish1",
    size: 6,
    src: "fishing-shot/images/fish1.png?" + Math.random()
  }, {
    id: "fish2",
    size: 16,
    src: "fishing-shot/images/fish2.png?" + Math.random()
  }, {
    id: "fish3",
    size: 11,
    src: "fishing-shot/images/fish3.png?" + Math.random()
  }, {
    id: "fish4",
    size: 15,
    src: "fishing-shot/images/fish4.png?" + Math.random()
  }, {
    id: "fish5",
    size: 43,
    src: "fishing-shot/images/fish5.png?" + Math.random()
  }, {
    id: "fish6",
    size: 45,
    src: "fishing-shot/images/fish6.png?" + Math.random()
  }, {
    id: "fish7",
    size: 80,
    src: "fishing-shot/images/fish7.png?" + Math.random()
  }, {
    id: "fish8",
    size: 100,
    src: "fishing-shot/images/fish8.png?" + Math.random()
  }, {
    id: "fish9",
    size: 104,
    src: "fishing-shot/images/fish9.png?" + Math.random()
  }, {
    id: "fish10",
    size: 121,
    src: "fishing-shot/images/fish10.png?" + Math.random()
  }, {
    id: "shark1",
    size: 287,
    src: "fishing-shot/images/shark1.png?" + Math.random()
  }, {
    id: "shark2",
    size: 382,
    src: "fishing-shot/images/shark2.png?" + Math.random()
  }, {
    id: "cannon1",
    size: 11,
    src: "fishing-shot/images/cannon1.png?" + Math.random()
  }, {
    id: "cannon2",
    size: 11,
    src: "fishing-shot/images/cannon2.png?" + Math.random()
  }, {
    id: "cannon3",
    size: 11,
    src: "fishing-shot/images/cannon3.png?" + Math.random()
  }, {
    id: "cannon4",
    size: 13,
    src: "fishing-shot/images/cannon4.png?" + Math.random()
  }, {
    id: "cannon5",
    size: 13,
    src: "fishing-shot/images/cannon5.png?" + Math.random()
  }, {
    id: "cannon6",
    size: 15,
    src: "fishing-shot/images/cannon6.png?" + Math.random()
  }, {
    id: "cannon7",
    size: 17,
    src: "fishing-shot/images/cannon7.png?" + Math.random()
  }, {
    id: "bullet",
    size: 8,
    src: "fishing-shot/images/bullet.png?" + Math.random()
  }, {
    id: "web",
    size: 93,
    src: "fishing-shot/images/web.png?" + Math.random()
  }, {
    id: "numBlack",
    size: 1,
    src: "fishing-shot/images/number_black.png?" + Math.random()
  }, {
    id: "coinAni1",
    size: 19,
    src: "fishing-shot/images/coinAni1.png?" + Math.random()
  }, {
    id: "coinAni2",
    size: 22,
    src: "fishing-shot/images/coinAni2.png?" + Math.random()
  }, {
    id: "coinText",
    size: 16,
    src: "fishing-shot/images/coinText.png?" + Math.random()
  }];
...
(function () {
  ...
  a.onLoadLoaded = function (a) {
    this.loader.innerHTML = "\u6B63\u5728\u52A0\u8F7D\u8D44\u6E90\u4E2D\uFF0C\u8BF7\u7A0D\u5019...<br>(" + Math.round(a.target.getLoadedSize() / a.target.getTotalSize() * 100) + "%)";
  };
...
(function () {
  ...
  b.prototype.update = function () {
    for (var e = 0; e < this.fishes.length; e++) {
      var b = this.fishes[e];
      if (b.captured) this.fishes.splice(e, 1), e--;else if (b.isOutOfScreen()) {
...
(function () {
  ...
  c.prototype.setValue = function (a) {
    ...
    if (this.autoAddZero) for (var d = this.addSign ? e - 1 : e; b.length < d;) {
      b = "0" + b;
    }
...
(function () {
  ...
  b.prototype.changeDirection = function (b) {
    if (b != void 0) this.setDirection(b);else if (Math.random() > 0.8) b = Math.random() > 0.5 ? 1 : -1, this._destRotation = this.rotation + (Math.random() * 10 + 20 >> 0) * b >> 0;
    var b = a.fps,
        c = b * 5;
  ...
  b.prototype.update = function () {
    ...
    } else this.moving && (this.x += this.speedX, this.y += this.speedY), this._destRotation != null ? (b = this._destRotation - this.rotation, d = b > 0 ? 0.1 : -0.1, h = this.rotation + d, b == 0 || d > 0 && h >= this._destRotation || d < 0 && h <= this._destRotation ? (this.setDirection(this._destRotation), this._destRotation = null) : this.setDirection(h)) : --this.changeDirCounter <= 0 && this.canTurning && this.changeDirection();
  };

  b.prototype.isOutOfScreen = function () {
    if (this.x < -this.width || this.x > a.width + this.width || this.y < -this.height || this.y > a.height + this.height) return !0;else if (this.x > 100 && this.x < a.width - 100 && this.y > 100 && this.y < a.height - 100) this.canTurning = !0;
    return !1;
  };
})();
...
(function () {
  ...
  b.prototype.checkCollision = function () {
    for (var b = a.fishManager.fishes, d = b.length, h = !1, i = 0; i < d; i++) {
      ...
      if (!(this.y - this.height * 0.5 > g.y + g.height * 0.5 || this.y + this.height * 0.5 < g.y - g.height * 0.5 || this.x - this.width * 0.5 > g.x + g.width * 0.5 || this.x + this.width * 0.5 < g.x - g.width * 0.5) && this.hitTestObject(g, !0)) {
        h = !0;
        break;
      }
    }
    ...
    for (i = 0; i < d; i++) {
      if (g = b[i], !(f.y - f.height * 0.5 > g.y + g.height * 0.5 || f.y + f.height * 0.5 < g.y - g.height * 0.5 || f.x - f.width * 0.5 > g.x + g.width * 0.5 || f.x + f.width * 0.5 < g.x - g.width * 0.5) && f.hitTestObject(g, !0) && g.canBeCaptured(this.power - 1)) g.moving = !1, g.captured = !0, g.capturingCounter = a.fps >> 1, g.gotoAndPlay("capture");
    }
