...
R.sources =
[
	//{id:"cannon", size:50, src:"fishing-shot/images/cannon-hd.png?"+Math.random()},
	//{id:"fish", size:50, src:"fishing-shot/images/fish-hd.png?"+Math.random()},
	//{id:"shark", size:50, src:"fishing-shot/images/shark-hd.png?"+Math.random()},
	{id:"mainbg", size:456, src:"fishing-shot/images/game_bg_2_hd.jpg?"+Math.random()},
	{id:"bottom", size:50, src:"fishing-shot/images/bottom.png?"+Math.random()},
	{id:"fish1", size:6, src:"fishing-shot/images/fish1.png?"+Math.random()},
	{id:"fish2", size:16, src:"fishing-shot/images/fish2.png?"+Math.random()},
	{id:"fish3", size:11, src:"fishing-shot/images/fish3.png?"+Math.random()},
	{id:"fish4", size:15, src:"fishing-shot/images/fish4.png?"+Math.random()},
	{id:"fish5", size:43, src:"fishing-shot/images/fish5.png?"+Math.random()},
	{id:"fish6", size:45, src:"fishing-shot/images/fish6.png?"+Math.random()},
	{id:"fish7", size:80, src:"fishing-shot/images/fish7.png?"+Math.random()},
	{id:"fish8", size:100, src:"fishing-shot/images/fish8.png?"+Math.random()},
	{id:"fish9", size:104, src:"fishing-shot/images/fish9.png?"+Math.random()},
	{id:"fish10", size:121, src:"fishing-shot/images/fish10.png?"+Math.random()},
	{id:"shark1", size:287, src:"fishing-shot/images/shark1.png?"+Math.random()},
	{id:"shark2", size:382, src:"fishing-shot/images/shark2.png?"+Math.random()},
	{id:"cannon1", size:11, src:"fishing-shot/images/cannon1.png?"+Math.random()},
	{id:"cannon2", size:11, src:"fishing-shot/images/cannon2.png?"+Math.random()},
	{id:"cannon3", size:11, src:"fishing-shot/images/cannon3.png?"+Math.random()},
	{id:"cannon4", size:13, src:"fishing-shot/images/cannon4.png?"+Math.random()},
	{id:"cannon5", size:13, src:"fishing-shot/images/cannon5.png?"+Math.random()},
	{id:"cannon6", size:15, src:"fishing-shot/images/cannon6.png?"+Math.random()},
	{id:"cannon7", size:17, src:"fishing-shot/images/cannon7.png?"+Math.random()},
	{id:"bullet", size:8, src:"fishing-shot/images/bullet.png?"+Math.random()},
	{id:"web", size:93, src:"fishing-shot/images/web.png?"+Math.random()},
	{id:"numBlack", size:1, src:"fishing-shot/images/number_black.png?"+Math.random()},
	{id:"coinAni1", size:19, src:"fishing-shot/images/coinAni1.png?"+Math.random()},
	{id:"coinAni2", size:22, src:"fishing-shot/images/coinAni2.png?"+Math.random()},
	{id:"coinText", size:16, src:"fishing-shot/images/coinText.png?"+Math.random()}
];
